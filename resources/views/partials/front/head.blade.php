<head>
  ...
  <!-- Google tag (gtag.js) -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=AW-18303134293"></script>
  <script>
    ...
    gtag('js', new Date());
    gtag('config', 'AW-18303134293');
    gtag('config', 'G-HVQN15H2RT');
  </script>
  ...
  <script>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-P2RPD48D');
  </script>
