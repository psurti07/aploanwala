        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-12 col-lg-6 self-apply-form order-1 order-md-2 order-lg-2 mb-lg-0 mb-25">
                <div id="hero-8-form" class="r-06">
                    ...
                    <p class="p-sm mt-3 mb-0 text-start">By submitting the form & proceeding, you agree to the <a href="{{ route('front.terms.conditions') }}" target="_blank" class="text-dark text-decoration-none">Terms</a> and <a href="{{ route('front.privacy.policy') }}" target="_blank" class="text-dark text-decoration-none"> Privacy Policy</a> of APloannwala.</p>
                </div>
            </div>
        </div>
    </div>
