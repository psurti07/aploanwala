    ...
    function nbfcsList()
    {
        ...
        foreach ($banks as $bank) {
            ...
            $data['carousel'] .= '<div class="bg--white-100 r-10 mb-20 p-md-2 p-2">
                                    <a href="javascript:;">
                                        <img class="img-fluid" src="https://manage.aploannwala.com/upload/banks/' . $bank->bank_image . '" alt="' . $bank->bank_name . '" width="100">
                                    </a>
                                </div>';
            $loop++;
        }
                ...
                <li class="accordion-item mb-0">
                    ...
                    <div class="accordion-panel">
                        <div class="accordion-panel-item">
                            <div class="faqs-2-answer">
                                <p>
                                    We request you to kindly call the company on +91-92717-59598 between 10 AM to 5 PM- Monday to Saturday (only business days). Allow us to discuss your concerns, and we will ensure that you receive the best solutions possible. 
                                </p>
                            </div>
                        </div>
                    </div>
